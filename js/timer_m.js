...
function printClock() {
    ...
    clock.innerHTML = currentHours+":"+currentMinute+":"+currentSeconds +" <span style='font-size:30px; max-width:730px; max-height:initial; width:100%; height:100%;'>"+ amPm+"</span>"; //날짜를 출력해 줌
